                ...
                writer.writerow(
                    {
                        ...
                        "raw_image_score": "" if payload["raw_image_score"] is None else payload["raw_image_score"],
                        "raw_score_semantic": payload["raw_score_semantic"],
                        "raw_anomaly_map": payload["raw_anomaly_map"],
                        "postprocessed_image_score": (
                            "" if payload["postprocessed_image_score"] is None else payload["postprocessed_image_score"]
                        ),

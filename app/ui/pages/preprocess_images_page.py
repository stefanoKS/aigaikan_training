...
class PreprocessImagesPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.preview_workspace.setObjectName("PreprocessPreviewWorkspace")
        self.preview_workspace.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        ...
        self.settings_scroll_area.setFrameShape(QScrollArea.Shape.NoFrame)
        self.settings_scroll_area.viewport().setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        ...
        settings_content.setObjectName("PreprocessSettingsContent")
        settings_content.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
